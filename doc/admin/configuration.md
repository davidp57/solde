...
8. **Importer les données historiques** si nécessaire (voir [excel-import.md](./excel-import.md)).
...
8. **Import historical data** if needed (see [excel-import.md](./excel-import.md)).
