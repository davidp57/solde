...
- **Avancement actuel** : le lot 1 texte est rédigé dans `doc/user/README.md` et `doc/user/manuel-utilisateur-lot-1.md`, avec un périmètre volontairement calé sur les écrans réellement disponibles aujourd'hui.
...
- **BL-021** — `created=2026-04-13`, `started=2026-04-13` — Rédaction du premier lot du manuel utilisateur en français, centré sur les parcours métier essentiels avant enrichissement visuel final.
