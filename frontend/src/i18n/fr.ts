export default {
  ...
  settings: {
    ...
    backup_onedrive_manual_info: 'Sur une machine avec un navigateur (votre PC, pas le NAS), exécutez la commande ci-dessous. Copiez le JSON affiché et collez-le dans le champ Token.',
    backup_onedrive_token_paste: 'Token JSON (sortie de rclone authorize)',
    backup_onedrive_token_valid: 'Token valide ✓',
    backup_onedrive_token_invalid: 'JSON invalide ou champ access_token manquant',
    backup_onedrive_authorized: 'OneDrive autorisé',
    backup_onedrive_waiting: "En attente d'autorisation…",
    backup_onedrive_timeout: "Délai d'attente dépassé, veuillez réessayer.",
