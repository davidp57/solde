  ...
  invoices: {
    client: {
      ...
      metrics: {
        ...
        remaining_exercise_amount: "Restant a payer de l'exercice",
        exercise_count: '{count} facture(s) ouvertes sur {fiscal_year}',
        exercise_count_all: '{count} facture(s) ouvertes sur la selection courante',
        total_receivables_amount: 'Encours adherents total',
        total_receivables_count: '{count} facture(s) ouvertes toutes periodes',
        historical_carryover: 'dont {count} facture(s) anterieures pour {amount} EUR',
        remaining_amount: 'Restant a payer',
