...
from backend.schemas.invoice import InvoiceCreate, InvoiceRead, InvoiceStatusUpdate, InvoiceUpdate
...
@router.post(
    "/{invoice_id}/duplicate", response_model=InvoiceRead, status_code=status.HTTP_201_CREATED
)
